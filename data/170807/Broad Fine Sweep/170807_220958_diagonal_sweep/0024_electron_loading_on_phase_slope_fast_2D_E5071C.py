...
Vtrap_max = 0.280 #To probe the chemical potential of the ensemble
...
if __name__ == "__main__":
    ...
    if 1:#do_check_f0 and (not((target_deltaf-0.15E6) < np.abs(f0-6.40511E9) < (target_deltaf+0.05E6)) or Q < target_Q):
        unload()
        load_electrons = True
    ...
    for m, voltages in tqdm(enumerate(zip(Vress, Vtraps, Vresguards))):
        ...
        Npts2 = int(np.abs(Vtrap_stops[m]-Vtrap_parks[m])/0.30E-3)
