...
Vtrap_parks, Vtrap_stops, Vtrap_backs, Vrg_starts, Vrg_stops, Vrg_backs = \
                    generate_sweep_points(0.450, 0.300)
Vtrap_park = Vtrap_parks[0]
...
if __name__ == "__main__":
    ...
    Vtrap_parks_i = np.float(raw_input("Specify first trap load voltage:"))
    Vtrap_parks_f = np.float(raw_input("Specify last trap load voltage:"))

    Vtrap_parks, Vtrap_stops, Vtrap_backs, Vrg_starts, Vrg_stops, Vrg_backs = \
                        generate_sweep_points(Vtrap_parks_i, Vtrap_parks_f)
